...
<div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="ref_ktgportofolio">
                    <option value=""></option>
                    <?php 
                    foreach ($ktgportofolio as $t) {
                    ?> 
  ...
  function getKtg() {
      $.ajax({
          url: "<?php echo site_url('')?>/portofolio/getKtg/",
          type: "POST",
          dataType: "JSON",
          success: function(data) {
            $.each( data, function( key, value ) {
                $('[name="ref_ktgportofolio"').append('<option value="'+ value.id +'">'+ value.judul +'</option>')
              });
  ...
  function edit_data(id) {
      ...
      $.ajax({
          ...
          success: function(data) {
              $('[name="id"]').val(data.id);
              $('[name="ref_ktgportofolio"]').val(data.ref_ktgportofolio);
