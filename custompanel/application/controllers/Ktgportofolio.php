...
class Ktgportofolio extends CI_Controller {
    
    public $table       = 'm_ktgportofolio';
    public $judul       = 'Kategori Portofolio';
    public $aktifgrup   = 'ktgportofolio';
    public $aktifmenu   = 'ktgportofolio';
    public $foldername  = 'ktgportofolio';
    public $indexpage   = 'ktgportofolio/v_ktgportofolio';
