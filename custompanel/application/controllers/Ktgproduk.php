...
class Ktgproduk extends CI_Controller {
    
    public $table       = 'm_ktgproduk';
    public $judul       = 'Kategori Produk';
    public $aktifgrup   = 'ktgproduk';
    public $aktifmenu   = 'ktgproduk';
    public $foldername  = 'ktgproduk';
