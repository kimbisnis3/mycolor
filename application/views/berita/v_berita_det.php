...
<div class="breadcrumbs">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="crumbs">You are here: <a href="<?php echo base_url() ?>">Home</a><span class="crumbs-span">&raquo;</span><span><a href="<?php echo base_url() ?>promo">Daftar Promo</a></span><span class="crumbs-span">&raquo;</span><span><?php echo $maindata->judul; ?></span></div>
				</div>
			</div><!-- End row -->
		</div><!-- End container -->
	</div><!-- End breadcrumbs -->
