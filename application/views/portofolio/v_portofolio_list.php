	...
	<div class="sections">
		<div class="container">
			<div class="sections-title">
				<div class="sections-title-h3"><h3><?php echo $ktgportofolio->judul ?></h3></div>
				<p>Berikut Ini Adalah Daftar Portofolio dari Kategori <strong><?php echo $ktgportofolio->judul ; ?></strong>.</p>
